...
import JOW.util.JsfUtil;
import JOW.util.PaginationHelper;
...
public class EmployeesController implements Serializable {
    ...
    @EJB
    private JOW.EmployeesFacade ejbFacade;
    ...
    public Employees getSelected() {
        if (current == null) {
            ...
            current.setEmployeesPK(new JOW.EmployeesPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Employees getEmployees(JOW.EmployeesPK id) {
    ...
    public static class EmployeesControllerConverter implements Converter {
        ...
        JOW.EmployeesPK getKey(String value) {
            JOW.EmployeesPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new JOW.EmployeesPK();
        ...
        String getStringKey(JOW.EmployeesPK value) {
